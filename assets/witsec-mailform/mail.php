...
$to = "webquery@one.com.ar";														// To Address
$toAlt = "";												// Additional Recipients
$from = "webquery@one.com.ar";													// From Address
$fromName = "Mensaje vía Página Web";											// From Name
...
$template = "Hola, <br><br>Alguien completó el formulario de Fibra Óptica en la página web.<br>Que tengan un buen día.<br><br><br>{formdata}<br><br>Fecha: {date}<br>";											// Mail Template
...
$rcpSecret = "6LccUTAhAAAAAF1Dm8wT48CrSBO1uwo1Ssj_4we6";								// reCAPTCHA Secret Key
$smtp = ("1" == "1" ? true : false);							// Use SMTP
$smtpDebug = ("0" == "1" ? 3 : 0);						// SMTP Debug
$smtpHost = "mail.estudioppa.com";											// SMTP Host
$smtpPort = "465";											// SMTP Port
$smtpSecure = "tls";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "web@estudioppa.com";									// SMTP Username
$smtpPassword = "JCzHRJw^oGUb";									// SMTP Password
